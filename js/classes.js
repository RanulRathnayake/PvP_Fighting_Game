class Sprite {
    constructor({position,imageSrc,scale = 1,frameMax=1, frameCurrent = 0, frameElapsed = 0, frameHolds =50, offset = {x:0, y:0} }) {
    ...
    animateFrame(){
        ...
        if(this.frameElapsed % this.frameHolds === 0){
...
class Fighter extends Sprite {
    ...
    switchSprite(sprite){
        ...
        //override when fighter get hits
